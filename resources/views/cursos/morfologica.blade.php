    ...
    <div class="row">
        <div class="col" style="margin-top:30px">
            ...
            <h2>Morfológica o 
                ...
                <a class="btn" style="float: right; color:#10312B"  href="{{ route('honorifico')}}"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Siguiente</a>
                <a class="btn" style="float: right; color:#691C32 " href="{{ route('cursos')}}">Salir <i class="fa fa-arrow-circle-left" aria-hidden="true"></i></a>
